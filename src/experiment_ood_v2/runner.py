...
from .utils import add_artifact, apply_structural_mutation, apply_intensity_shift, save_temp_nifti, add_mirror_artifact
            ...
            for i in range(4):
                ...
                if group_name == "Artificial Artifact":
                    # [FIX] Truyền thêm gt_data_np vào đây
                        ...
                        ood_data = add_mirror_artifact(data, gt_data=gt_data_np)
